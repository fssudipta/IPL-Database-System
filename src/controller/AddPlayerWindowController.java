...
public class AddPlayerWindowController {
    ...
    public void addPlayer(ActionEvent event) {
        try {
            ...
            if(position.equalsIgnoreCase("bowler")) position = "Bowler";
            else if(position.equalsIgnoreCase("batsman")) position = "Batsman";
            else if(position.equalsIgnoreCase("allrounder")) position = "Allrounder";
            else if(position.equalsIgnoreCase("wicketkeeper")) position = "Wicketkeeper";
            ...
            Player newPlayer = new Player(name, country, age, height, club.getClubName(), position, jerseyNumber, weeklySalary);
